...
package com.jxtele.sealonline_library.net.http;

import android.app.Application;
import android.content.Context;
import android.text.TextUtils;
import com.jxtele.sealonline_library.net.http.cache.RxCache;
import com.jxtele.sealonline_library.net.http.cache.converter.IDiskConverter;
import com.jxtele.sealonline_library.net.http.cache.converter.SerializableDiskConverter;
import com.jxtele.sealonline_library.net.http.cache.model.CacheMode;
import com.jxtele.sealonline_library.net.http.cookie.CookieManger;
import com.jxtele.sealonline_library.net.http.https.HttpsUtils;
import com.jxtele.sealonline_library.net.http.interceptor.HttpLoggingInterceptor;
import com.jxtele.sealonline_library.net.http.model.HttpHeaders;
import com.jxtele.sealonline_library.net.http.model.HttpParams;
import com.jxtele.sealonline_library.net.http.request.CustomRequest;
import com.jxtele.sealonline_library.net.http.request.DeleteRequest;
import com.jxtele.sealonline_library.net.http.request.DownloadRequest;
...
import com.jxtele.sealonline_library.net.http.request.PutRequest;
import com.jxtele.sealonline_library.net.http.utils.HttpLog;
import com.jxtele.sealonline_library.net.http.utils.RxUtil;
import com.jxtele.sealonline_library.net.http.utils.Utils;
import java.io.File;
